...
V4 (03/06/2026): após feedback do Denis sobre V3 — 11 comentários aplicados.
...
OUTPUT   = "/sessions/peaceful-lucid-edison/mnt/TCC/Resultados Preliminares - Cristiano Gouveia Silverio - V4-20260603.docx"
...
rows = [
    ...
    ("categoria_cookies", "categórica",
     ...
     "Vu et al. (2023); Pantelic et al. (2022)"),
    ("menciona_lgpd", "binária",
     ...
     "Mori et al. (2023); Javed e Sajid (2024)"),
]
for row in rows:
